...
BEGIN
	...
	BEGIN
		...
		SELECT DonXinPhep.Id AS DonXinPhepId, NhanVien.Id AS NhanVienId, Ho, Ten, TinhTrang, NgayBatDau, NgayKetThuc, SoPhepConLai, ISNULL(SoNgayDaNghi,0) AS SoNgayDaNghi, 
